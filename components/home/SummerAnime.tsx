...
const SummerAnime = ({ anime }: { anime: AnimeCardProps[] }) => {
  // กรองอนิเมะฤดูร้อน
  const summerAnime = anime.filter((animeItem) =>
    animeItem.premiered?.toLowerCase().includes("summer")
  );
